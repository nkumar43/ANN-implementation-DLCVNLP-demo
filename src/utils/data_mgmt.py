...
def get_data(validation_datasize):
    ...
    # Scale the data between 0 to 1 by dividing it by 255, as its an unsigned data in 0-255 range
    ...
    return (X_train, y_train), (X_valid, y_valid), (X_test, y_test), (X_test, y_test)